...
<nav id="sidebar">
	...
	<ul class="list-unstyled components">
		...
		<li>
			<a href="BillCustomerDetails.jsp" style="color: #fafafa; background-color: transparent;">
		...
		<li>
			<a href="#pageSubmenu" style="color: #fafafa; background-color: transparent;" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
				<img src="images/uses.png" alt="" border=3 height=27 width=27 style="float: left; margin-right: 0.5em">Doctors
			</a>
			<ul class="collapse list-unstyled" id="pageSubmenu">
				<li>
					<a href="" style="color: #fafafa; background-color: transparent;">1
					</a>
				</li>				
				<li>
					<a href="" style="color: #fafafa; background-color: transparent;">2
					</a>
				</li>
				<li>
					<a href="" style="color: #fafafa; background-color: transparent;">3
					</a>
				</li>
			</ul>	
		</li>
		...
		<li>
			<a href="#pageSubmenu" style="color: #fafafa; background-color: transparent;" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
				<img src="images/homes.png" alt="" border=3 height=27 width=27 style="float: left; margin-right: 0.5em">Patients
			</a>
			<ul class="collapse list-unstyled" id="pageSubmenu">
				<li>
					<a href="" style="color: #fafafa; background-color: transparent;">1
